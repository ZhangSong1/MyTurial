		...
		editor.addCommand('simage', {
			exec: function (editor) {
				...
				a.onchange = function(){
					...
					loaderHtmlStr = '<div style="position: relative; z-index: 100;width: 100%;height: 100%;text-align: center;background: white;opacity: 0.75;pointer-events:none">' + '<img src="image/loading.gif" style="width: 100%;height: 100%;margin-top: 100px;">' + '</div>';
	        ...
	        var options = {
	                ...
	                error: function(data, textStatus){
	                  ...
	                  b.className = 'message alert alert-danger';
	                  m = document.createElement('span');
	                  m.innerHTML = "Image upload failed! "+data.map.message+"Please try again!";
	                  b.appendChild(m);
	                  c = document.createElement('span');
	                  c.className = 'close';
	                  c.innerHTML = 'X';
